...
namespace Irony.Interpreter.Ast
{
	...
	{
		private OperatorInfoDictionary registeredOperators;

		public OperatorHandler(bool languageCaseSensitive)
		{
			this.registeredOperators = new OperatorInfoDictionary(languageCaseSensitive);
			this.BuildDefaultOperatorMappings();
		}

		public virtual OperatorInfoDictionary BuildDefaultOperatorMappings()
		{
			var dict = this.registeredOperators;
			dict.Clear();
		...
		{
			OperatorInfo opInfo;
			if (this.registeredOperators.TryGetValue(symbol, out opInfo))
