	...
	public partial class LanguageRuntime
	{
		...
		public object ExecuteBinaryOperator(ExpressionType op, object arg1, object arg2, ref OperatorImplementation previousUsed)
		{
			...
			catch (NullReferenceException)
			{
				...
				this.CheckUnassigned(arg1);
				this.CheckUnassigned(arg2);
				throw;
			}
			...
			if (currentImpl == null)
			{
				...
				if (!this.OperatorImplementations.TryGetValue(key, out currentImpl))
					this.ThrowScriptError(Resources.ErrOpNotDefinedForTypes, op, arg1Type, arg2Type);
			}
			...
			catch (OverflowException)
			{
				...
				// Set previousUsed to overflowHandler, so it will be used next time
				previousUsed = currentImpl.OverflowHandler;

				// Call self recursively
				return this.ExecuteBinaryOperator(op, arg1, arg2, ref previousUsed);
			}
		...
		public object ExecuteUnaryOperator(ExpressionType op, object arg1, ref OperatorImplementation previousUsed)
		{
			...
			if (currentImpl == null)
			{
				...
				if (!OperatorImplementations.TryGetValue(key, out currentImpl))
					this.ThrowError(Resources.ErrOpNotDefinedForType, op, arg1Type);
			}
